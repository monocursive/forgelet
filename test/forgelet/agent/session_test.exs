defmodule Forgelet.Agent.SessionTest do
  use Forgelet.DataCase

  alias Forgelet.{Agent, Identity, Repository, Event}
  ...
  test "starts and cleans up a mock Claude session for a claimed intent" do
    {:ok, _pid, agent_id} = Agent.spawn(:coder)
