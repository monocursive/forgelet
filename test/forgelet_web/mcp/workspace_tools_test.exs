defmodule ForgeletWeb.MCP.WorkspaceToolsTest do
  use Forgelet.DataCase

  alias Forgelet.{Agent, Git, Identity, Repository, Event}
  alias Forgelet.Agent.Workspace
  alias ForgeletWeb.MCP.Tools.{PrepareWorkspace, PublishArtifact}
